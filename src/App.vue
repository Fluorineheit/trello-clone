...
<template>
  <main class="p-5 font-sans bg-[url(../bg.webp)] bg-cover bg-center min-h-screen ">
    <div class="flex gap-5 py-5 overflow-x-auto">
      <div :key="list.id" v-for="(list, listIndex) in lists"
        ...
        <draggable group="cards" :list="list.cards" item-key="id" :animation="200"
          ...
          <template #item="{ element }">
            <div @click="openModal(listIndex, element)" class="bg-white p-3 my-2 rounded cursor-pointer break-all"
        ...
        <button @click="openModal(listIndex)"
